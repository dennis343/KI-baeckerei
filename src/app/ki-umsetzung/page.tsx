          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="border-t border-white/20 pt-8">
                ...
                <p className="text-base text-white/80 leading-relaxed font-light">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mx-auto max-w-4xl w-full">
          ...
          <div className="space-y-6">
            {[
              ...
              <details key={i} className="group border-t border-white/20 py-6 cursor-pointer">
                ...
                <p className="mt-6 text-white/80 leading-relaxed font-light">{faq.a}</p>
              </details>
            ))}
          </div>
        </div>
